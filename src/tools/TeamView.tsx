...
export const TeamAssignmentsView: React.FC<TeamAssignmentsViewProps> = ({ project, onUpdateTeam, currentUser }) => {
    // Removed local state to avoid synchronization issues and setState in useEffect
    const teamAssignments = project.team || [];
    ...
    const handleAssignmentChange = (role, field, value) => {
        ...
        // We keep all roles in the team array, even if unassigned, to ensure the dashboard count is correct
        // and matches the Resources & Skills List.
